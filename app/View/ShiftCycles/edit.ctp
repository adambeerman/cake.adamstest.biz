...
<?php echo $this->Form->create('ShiftCycle'); ?>
	<fieldset>
		<legend><?php echo __('Edit Shift Cycle'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ShiftCycle.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ShiftCycle.id'))); ?></li>
